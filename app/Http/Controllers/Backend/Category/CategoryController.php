...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.category.save', compact('attributes', 'attributeValues'));
    }
    ...
    protected function getAttributesAndValues()
    {
        ...
        return compact('attributes', 'attributeValues');
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('backend.category.save', compact('attributes', 'category', 'attributeValues'));
    }
