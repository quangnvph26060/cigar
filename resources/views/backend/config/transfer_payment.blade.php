...
@section('content')
    <form action="{{ route('admin.configs.configTransferPayment') }}" method="post">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ $configPayment->name }}">
                </div>

                <div class="form-group mb-3">
                    <label for="" class="form-label">Mô tả</label>
                    <textarea name="description" id="" cols="30" rows="3" class="form-control">{{ $configPayment->description }}</textarea>
                </div>
                ...
                <div class="form-group mb-3">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @php
                                $accountDetails = $configPayment->account_details ?? [
                                    'account_name' => [],
                                    'account_number' => [],
                                    'bank_code' => [],
                                ];
