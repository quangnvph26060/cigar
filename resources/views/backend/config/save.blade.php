                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="info" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-12">
                                        ...
                                        <input type="text" value="{{ $config->title }}" name="title" id="title"
                                            placeholder="Tiêu Đề Trang Web" class="form-control">
                                    </div>

                                    <div class="form-group mb-3 col-lg-6">
                                        <label for="website_name" class="form-label">Tên Trang Web</label>
                                        <input value="{{ $config->website_name }}" type="text" name="website_name"
                                            id="website_name" placeholder="Tên Trang Web" class="form-control">
                                    </div>

                                    <div class="form-group mb-3 col-lg-6">
                                        <label for="email" class="form-label">Địa Chỉ Email</label>
                                        <input value="{{ $config->email }}" type="text" name="email" id="email"
                                    ...
                                    <div class="form-group mb-3 col-lg-6">
                                        ...
                                        <input value="{{ $config->phone_number }}" type="text" name="phone_number"
                                            id="phone_number" placeholder="Số Điện Thoại Liên Hệ" class="form-control">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="address" class="form-label">Địa Chỉ</label>
                                        <input value="{{ $config->address }}" type="text" name="address" id="address"
                                            placeholder="Địa Chỉ" class="form-control">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="copyright" class="form-label">Chân Trang</label>
                                        <input value="{{ $config->copyright }}" type="text" name="copyright"
                                            id="copyright" placeholder="Chân Trang" class="form-control">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="intro_title" class="form-label">Tiêu Đề Giới Thiệu</label>
                                        <input value="{{ $config->intro_title }}" type="text" name="intro_title"
                                            id="copyright" placeholder="Tiêu Đề Giới Thiệu" class="form-control">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ $config->restriction_message }}"
                                        placeholder="Cảnh Báo Pháp Lý" id="restriction_message"
                                        name="restriction_message" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="adult_only_policy" class="form-label">Chính sách giới hạn độ tuổi</label>
                                    <input type="text" value="{{ $config->adult_only_policy }}"
                                        placeholder="Chính sách giới hạn độ tuổi" id="adult_only_policy"
                                        name="adult_only_policy" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
